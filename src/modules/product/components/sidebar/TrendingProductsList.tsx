...
export type TrendingProduct = Pick<Product, 'id' | 'name' | 'description'> & { imageUrl: string }
...
const TrendingProductsList: React.FC = () => (
  <Box>
    <ProductSubHeading>Trending</ProductSubHeading>
